...
builder.Services.AddDbContext<RecipeContext>(options => options.UseMySql(mySqlConnection, new MySqlServerVersion(new Version(8, 0, 31))));
...
{
    string token = builder.Configuration.GetValue<String>("Authentication:Token");
